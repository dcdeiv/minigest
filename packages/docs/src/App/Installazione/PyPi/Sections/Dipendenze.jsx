...
import { Section, HeaderSection, AdapterLink, CodeBlock } from "src/Components";

export function Dipendenze(props) {
  return (
    <Section>
      <HeaderSection>
      ...
      <Typography>
        Minigest fa affidamento su <b>Postgresql</b> e su <b>WeasyPrint</b> e
