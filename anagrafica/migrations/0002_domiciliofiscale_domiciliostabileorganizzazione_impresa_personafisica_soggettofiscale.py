    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codice_destinatario', common.models.fields.uppercase.UpperCaseField(default='0000000', max_length=7, validators=[django.core.validators.MinLengthValidator(6)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_fiscale_iva_paese', common.models.fields.uppercase.UpperCaseField(blank=True, default=None, help_text='es: IT', max_length=2, null=True, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='codice paese partita IVA')),
                ('id_fiscale_iva_codice', common.models.fields.uppercase.UpperCaseField(blank=True, default=None, help_text='per paesi extra EU inserire 99999999999', max_length=28, null=True, validators=[django.core.validators.MinLengthValidator(1)], verbose_name='codice partita IVA')),
                ('codice_fiscale', common.models.fields.uppercase.UpperCaseField(blank=True, default=None, help_text='compilare solo se diverso dalla partita IVA', max_length=16, null=True, validators=[django.core.validators.MinLengthValidator(11)])),
                ...
                ('albo_provincia', common.models.fields.uppercase.UpperCaseField(blank=True, default=None, help_text='es: MI', max_length=2, null=True, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Provincia Albo')),
                ...
                ('rea_ufficio', common.models.fields.uppercase.UpperCaseField(blank=True, default=None, help_text="provincia dell'Ufficio REA, es: MI", max_length=2, null=True, validators=[django.core.validators.MinLengthValidator(2)], verbose_name='Ufficio REA')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provincia', common.models.fields.uppercase.UpperCaseField(blank=True, help_text='es: MI - da valorizzare solo se nazione è uguale a IT (Italia)', max_length=2, null=True, validators=[django.core.validators.MinLengthValidator(2)])),
                ('nazione', common.models.fields.uppercase.UpperCaseField(help_text='es: IT', max_length=2, validators=[django.core.validators.MinLengthValidator(2)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codice_fiscale', common.models.fields.uppercase.UpperCaseField(max_length=16, validators=[django.core.validators.MinLengthValidator(11)])),
